...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Member', path: '/members', entity: 'member', service: AccessServiceEnum.PROJECT, icon: FiUsers },
  { name: 'Schedule', path: '/schedules', entity: 'schedule', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
  {
    name: 'Workout Plan',
    path: '/workout-plans',
    entity: 'workout_plan',
